...
namespace Enderlook.Unity.Threading.Jobs
{
    public static partial class IManagedJobExtensions
    {
        ...
        public static JobHandle ScheduleAndWatch(this Action job, JobHandle dependsOn = default)
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1>(this Action<T1> job, T1 p1, JobHandle dependsOn = default)
            => job.Schedule(p1, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2>(this Action<T1, T2> job, T1 p1, T2 p2, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3>(this Action<T1, T2, T3> job, T1 p1, T2 p2, T3 p3, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4>(this Action<T1, T2, T3, T4> job, T1 p1, T2 p2, T3 p3, T4 p4, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4, T5>(this Action<T1, T2, T3, T4, T5> job, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, p5, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4, T5, T6>(this Action<T1, T2, T3, T4, T5, T6> job, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, p5, p6, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4, T5, T6, T7>(this Action<T1, T2, T3, T4, T5, T6, T7> job, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, p5, p6, p7, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4, T5, T6, T7, T8>(this Action<T1, T2, T3, T4, T5, T6, T7, T8> job, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, p5, p6, p7, p8, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4, T5, T6, T7, T8, T9>(this Action<T1, T2, T3, T4, T5, T6, T7, T8, T9> job, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, p5, p6, p7, p8, p9, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> job, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9, T10 p10, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(this Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> job, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9, T10 p10, T11 p11, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(this Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> job, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9, T10 p10, T11 p11, T12 p12, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(this Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> job, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9, T10 p10, T11 p11, T12 p12, T13 p13, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(this Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> job, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9, T10 p10, T11 p11, T12 p12, T13 p13, T14 p14, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, dependsOn).WatchCompletition();
        ...
        /// <param name="dependsOn">Another job that must be executed before executing <paramref name="job"/>.</param>
        /// <returns>Job handle of the scheduled task.</returns>
        public static JobHandle ScheduleAndWatch<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>(this Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> job, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9, T10 p10, T11 p11, T12 p12, T13 p13, T14 p14, T15 p15, JobHandle dependsOn = default)
            => job.Schedule(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, dependsOn).WatchCompletition();
